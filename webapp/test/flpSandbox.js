		...
		services: {
					...
					"config": {
						"groups": [{
							"tiles": [{
								...
								"properties": {
									"title": "Sales Orders",
									"targetURL": "#sampleappzmasterdetail-display"
								}
							}]
						}]
					}
			...
			"ClientSideTargetResolution": {
				"adapter": {
					"config": {
						"inbounds": {
							"sampleappzmasterdetail-display": {
								"semanticObject": "sampleappzmasterdetail",
								"action": "display",
								...
								"resolutionResult": {
									...
									"additionalInformation": "SAPUI5.Component=sample.app.zmasterdetail",
									"url": sap.ui.require.toUrl("sample/app/zmasterdetail")
								}
							}
						}
					}
